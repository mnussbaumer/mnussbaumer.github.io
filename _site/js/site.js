(() => {
  // js/site.js
  (function() {
    const themes = [["dark-theme", "dark", "light-theme", "light"], ["light-theme", "light", "dark-theme", "dark"]], themes_values = themes.map(([theme, , ,]) => theme), default_theme = themes[0][0];
    ...
    function setup_theme() {
      ...
      try {
        ...
        if (themes_values.includes(saved_theme) && saved_theme != current_theme()) {
